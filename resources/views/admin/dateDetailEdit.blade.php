...
@endif
        ...
        <div class="form-group">
            <label>Modify checkin time</label>
                <div class="input-group date" id="timepicker" data-target-input="nearest" style="width: 300px;">
                    ...
                    @if($data->checkin_modify)
                        value={{$data->checkin_modify}}
                    @endif
                    data-target="#timepicker" style="width: 250px;" name='checkin_modify'/>
        ...
        <label>Modify checkout time</label>
            <div class="input-group date" id="timepicker" data-target-input="nearest" style="width: 300px;">
                <input type="text" class="form-control datetimepicker-input"
                @if($data->checkout_modify)
                    value={{$data->checkout_modify}}
                @endif
                data-target="#timepicker" style="width: 250px;" name='checkout_modify'/>
                    <div class="input-group-append" data-target="#timepicker" data-toggle="datetimepicker">
                        <div class="input-group-text"><i class="far fa-clock"></i></div>
                    </div>
            </div>
        ...
        <label>Modify Break time</label>
            <div class="input-group date" id="timepicker" data-target-input="nearest" style="width: 300px;">
                <input type="text" class="form-control datetimepicker-input"
                @if($data->break_time_modify)
                    value={{$data->break_time_modify}}
                @endif
                data-target="#timepicker" style="width: 250px;" name='breaktime_modify'/>
                    <div class="input-group-append" data-target="#timepicker" data-toggle="datetimepicker">
                        <div class="input-group-text"><i class="far fa-clock"></i></div>
                    </div>
            </div>
